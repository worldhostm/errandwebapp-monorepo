        ...
        <div className="mt-16 relative h-96 bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl shadow-xl overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-2xl font-semibold text-gray-700">주변 이웃과 함께하는 심부름 플랫폼</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">회원가입 및 로그인</h4>
                  <p className="text-gray-600 text-sm">간단한 정보만으로 가입하고 시작하세요</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">심부름 등록</h4>
                  <p className="text-gray-600 text-sm">필요한 심부름의 내용, 위치, 보상을 입력하세요</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">수행자와 연결</h4>
                  <p className="text-gray-600 text-sm">수락한 수행자와 채팅으로 소통하고 심부름을 완료하세요</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">주변 심부름 찾기</h4>
                  <p className="text-gray-600 text-sm">지도에서 내 위치 근처의 심부름을 확인하세요</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">원하는 심부름 수락</h4>
                  <p className="text-gray-600 text-sm">내가 할 수 있는 심부름을 선택하고 수락하세요</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">심부름 완료 및 보상</h4>
                  <p className="text-gray-600 text-sm">심부름을 완료하고 보상을 받으세요</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl">
            ...
            <h4 className="font-bold text-gray-900 mb-2">바쁜 직장인</h4>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl">
            <div className="text-4xl mb-3">🎓</div>
            <h4 className="font-bold text-gray-900 mb-2">대학생</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl">
            <div className="text-4xl mb-3">🏠</div>
            <h4 className="font-bold text-gray-900 mb-2">집에 계신 분</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl">
            <div className="text-4xl mb-3">🚶</div>
            <h4 className="font-bold text-gray-900 mb-2">이웃 도우미</h4>
            <p className="text-sm text-gray-600">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-gray-50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            ...
            <p className="font-semibold text-gray-900">장보기</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">📦</div>
            <p className="font-semibold text-gray-900">택배</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">🍔</div>
            <p className="font-semibold text-gray-900">음식 배달</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">🏥</div>
            <p className="font-semibold text-gray-900">약 수령</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">🐕</div>
            <p className="font-semibold text-gray-900">반려동물</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">🧹</div>
            <p className="font-semibold text-gray-900">청소</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">🚗</div>
            <p className="font-semibold text-gray-900">운전 대행</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow text-center">
            <div className="text-4xl mb-2">✨</div>
            <p className="font-semibold text-gray-900">기타</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 부름이. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
