...
exports.REQUEST_PATTERNS = exports.POPULAR_CATEGORIES_BY_LOCATION = exports.SAMPLE_CHATS = exports.SAMPLE_MESSAGES = exports.SAMPLE_ERRANDS = exports.SAMPLE_USERS = exports.ERRAND_CATEGORIES_KO = exports.DONGTAN2_LOCATIONS = exports.SEOUL_LOCATIONS = void 0;
// 서울 주요 지역 좌표 데이터 (위도, 경도)
exports.SEOUL_LOCATIONS = {
    gangnam: {
    ...
    myeongdong: {
        coordinates: [126.9870, 37.5636],
        address: "서울특별시 중구 명동"
    },
    itaewon: {
        coordinates: [126.9944, 37.5348],
        address: "서울특별시 용산구 이태원동"
    },
    jongno: {
        coordinates: [126.9910, 37.5703],
        address: "서울특별시 종로구 종로1가"
    },
    gangbuk: {
        coordinates: [127.0256, 37.6369],
        address: "서울특별시 강북구 수유동"
    },
    songpa: {
        coordinates: [127.1058, 37.5145],
        address: "서울특별시 송파구 잠실동"
    },
    mapo: {
        coordinates: [126.9155, 37.5663],
        address: "서울특별시 마포구 공덕동"
    },
    seocho: {
        coordinates: [127.0317, 37.4838],
        address: "서울특별시 서초구 서초동"
    },
    yeongdeungpo: {
        coordinates: [126.8965, 37.5266],
        address: "서울특별시 영등포구 영등포동"
    }
};
// 동탄2신도시 주요 지역 좌표 데이터
exports.DONGTAN2_LOCATIONS = {
    central_park: {
        coordinates: [127.0759, 37.2006],
        address: "경기도 화성시 동탄순환대로 중앙공원"
    },
    dongtan_station: {
        coordinates: [127.0748, 37.1987],
        address: "경기도 화성시 노작로 동탄역"
    },
    metapolis: {
        coordinates: [127.0801, 37.2019],
        address: "경기도 화성시 동탄대로 메타폴리스"
    },
    lotte_mart: {
        coordinates: [127.0732, 37.1995],
        address: "경기도 화성시 동탄대로 롯데마트"
    },
    banseok_elementary: {
        coordinates: [127.0785, 37.2031],
        address: "경기도 화성시 반석로 반석초등학교"
    },
    dongtan_lake_park: {
        coordinates: [127.0692, 37.2058],
        address: "경기도 화성시 동탄호수공원"
    },
    dongtan_complex: {
        coordinates: [127.0821, 37.1978],
        address: "경기도 화성시 동탄복합타운"
    },
    shindongtan_station: {
        coordinates: [127.0655, 37.2045],
        address: "경기도 화성시 신동탄역"
    },
    dongtan_hospital: {
        coordinates: [127.0812, 37.2003],
        address: "경기도 화성시 동탄의료센터"
    },
    dongtan_high_school: {
        coordinates: [127.0773, 37.2089],
        address: "경기도 화성시 동탄고등학교"
    }
};
// 카테고리 데이터 (한국어)
exports.ERRAND_CATEGORIES_KO = [
    "배달/픽업",
    "청소",
    "쇼핑",
    "반려동물 돌봄",
...
exports.SAMPLE_USERS = [
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.gangnam.coordinates,
            address: exports.SEOUL_LOCATIONS.gangnam.address
        },
        rating: 4.8,
        totalErrands: 23,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.hongdae.coordinates,
            address: exports.SEOUL_LOCATIONS.hongdae.address
        },
        rating: 4.9,
        totalErrands: 31,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.myeongdong.coordinates,
            address: exports.SEOUL_LOCATIONS.myeongdong.address
        },
        rating: 4.6,
        totalErrands: 18,
        isVerified: false,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.itaewon.coordinates,
            address: exports.SEOUL_LOCATIONS.itaewon.address
        },
        rating: 4.7,
        totalErrands: 42,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.jongno.coordinates,
            address: exports.SEOUL_LOCATIONS.jongno.address
        },
        rating: 4.5,
        totalErrands: 15,
        isVerified: true,
    ...
    // 동탄2신도시 사용자들
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.central_park.coordinates,
            address: exports.DONGTAN2_LOCATIONS.central_park.address
        },
        rating: 4.7,
        totalErrands: 28,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.dongtan_station.coordinates,
            address: exports.DONGTAN2_LOCATIONS.dongtan_station.address
        },
        rating: 4.9,
        totalErrands: 35,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.metapolis.coordinates,
            address: exports.DONGTAN2_LOCATIONS.metapolis.address
        },
        rating: 4.4,
        totalErrands: 12,
        isVerified: false,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.lotte_mart.coordinates,
            address: exports.DONGTAN2_LOCATIONS.lotte_mart.address
        },
        rating: 4.6,
        totalErrands: 19,
        isVerified: true,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.dongtan_lake_park.coordinates,
            address: exports.DONGTAN2_LOCATIONS.dongtan_lake_park.address
        },
        rating: 4.8,
        totalErrands: 41,
        isVerified: true,
...
exports.SAMPLE_ERRANDS = [
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.gangbuk.coordinates,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.songpa.coordinates,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.SEOUL_LOCATIONS.mapo.coordinates,
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.dongtan_complex.coordinates,
            address: exports.DONGTAN2_LOCATIONS.dongtan_complex.address
        },
        reward: 8000,
        currency: 'KRW',
        requestedBy: "user_006",
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.shindongtan_station.coordinates,
            address: exports.DONGTAN2_LOCATIONS.shindongtan_station.address
        },
        reward: 12000,
        currency: 'KRW',
        requestedBy: "user_007",
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.dongtan_hospital.coordinates,
            address: exports.DONGTAN2_LOCATIONS.dongtan_hospital.address
        },
        reward: 20000,
        currency: 'KRW',
        requestedBy: "user_009",
    ...
    },
    {
        ...
        location: {
            type: 'Point',
            coordinates: exports.DONGTAN2_LOCATIONS.dongtan_high_school.coordinates,
            address: exports.DONGTAN2_LOCATIONS.dongtan_high_school.address
        },
        reward: 15000,
        currency: 'KRW',
        requestedBy: "user_008",
...
// 샘플 채팅
exports.SAMPLE_CHATS = [
    {
        id: "chat_001",
        errand: "errand_001",
        participants: ["user_001", "user_002"],
        messages: exports.SAMPLE_MESSAGES,
        lastMessage: exports.SAMPLE_MESSAGES[exports.SAMPLE_MESSAGES.length - 1],
        createdAt: new Date('2024-08-31T10:00:00Z'),
        updatedAt: new Date('2024-08-31T10:15:00Z')
    }
];
// 지역별 인기 카테고리
exports.POPULAR_CATEGORIES_BY_LOCATION = {
